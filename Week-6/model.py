...
class UNet(nn.Module):
    def __init__(self, in_ch=1, base=64, time_dim=128, num_classes=10):
        super().__init__()
        ...
        self.bot1 = Block(base * 2, base * 2, time_dim)
        self.bot_attn = SelfAttention(base * 2)
        self.bot2 = Block(base * 2, base * 2, time_dim)

        self.up2 = nn.ConvTranspose2d(base * 2, base * 2, 2, stride=2)
        self.dec2 = Block(base * 4, base, time_dim)
        self.dec2_attn = SelfAttention(base)
    ...
    def forward(self, x, t, y):
        ...
        b = self.bot1(self.pool(d2), t_emb)
        b = self.bot_attn(b)
        b = self.bot2(b, t_emb)
